...
OUTPUT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "..", "ml_models", "experiments", "exp2-frozen-layers"
)
DATA_DIR = r"C:\Users\hp\Desktop\plagiarism-training-data"
ARABIC_PAIR_SAMPLE_SIZE = 10000
NUM_FROZEN_LAYERS = 9  # out of 12 total encoder layers; only the last 3 + pooling stay trainable
...
def main():
    ...
    print(f"EXPERIMENT 2: frozen lower layers ({NUM_FROZEN_LAYERS}/12) + full Arabic-NLi-Pair sample ({len(ar_pairs)})")
    ...
    print("Saved experiment 2 model to", OUTPUT_DIR)
